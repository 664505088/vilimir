...
+ (NSString *) udid{
    return [NSString encryptStr:[[[UIDevice currentDevice] identifierForVendor] UUIDString]];
}

+ (NSString *) encryptStr:(NSString *) str
{
    return [NSString doCipher:str key:_key context:kCCEncrypt];
}
+ (NSString *)decryptStr:(NSString *)str {
    return [NSString doCipher:str key:_key context:kCCDecrypt];
}
